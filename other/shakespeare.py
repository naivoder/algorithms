...
This program generates a given string over a long enough period of time.
It is intentionally brute force, this algorithm would be much more efficient using a hill-climbing approach.
"""
